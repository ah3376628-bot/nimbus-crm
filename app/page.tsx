...
const leads: Lead[] = [
  { name: 'Olivia Martin', company: 'Northstar Labs', value: '$24,500', status: 'New', avatar: 'OM', color: 'bg-[#dce8ff] text-[#3159a8]' },
  { name: 'Liam Anderson', company: 'Vertex Systems', value: '$18,200', status: 'Contacted', avatar: 'LA', color: 'bg-[#fce1d7] text-[#b34f38]' },
  { name: 'Sophia Brown', company: 'Acme Studios', value: '$32,800', status: 'Converted', avatar: 'SB', color: 'bg-[#e5ddff] text-[#6746b6]' },
  { name: 'Noah Williams', company: 'Brightline Co.', value: '$12,400', status: 'New', avatar: 'NW', color: 'bg-[#d8f1e6] text-[#347e5a]' },
]

const customers = [
  { name: 'Northstar Labs', contact: 'Olivia Martin', email: 'olivia@northstar.io', value: '$84,200', initials: 'NL', color: 'bg-[#dce8ff] text-[#3159a8]' },
  { name: 'Acme Studios', contact: 'Sophia Brown', email: 'sophia@acme.studio', value: '$61,500', initials: 'AS', color: 'bg-[#e5ddff] text-[#6746b6]' },
  { name: 'Vertex Systems', contact: 'Liam Anderson', email: 'liam@vertex.co', value: '$48,900', initials: 'VS', color: 'bg-[#fce1d7] text-[#b34f38]' },
]

const tasks = [
  { title: 'Follow up with Northstar Labs', meta: 'Today · High priority', done: false },
  { title: 'Send proposal to Acme Studios', meta: 'Tomorrow · Medium priority', done: false },
  { title: 'Schedule Q3 review with Vertex', meta: 'Friday · Low priority', done: true },
]
  ...
  return (
    <div className="crm-shell">
      <aside className={`sidebar ${mobileNav ? 'sidebar-open' : ''}`}>
        ...
        <div className="workspace-switch"><span className="workspace-dot" /> Acme Inc. <ChevronDown size={14} /></div>
        ...
        <div className="sidebar-bottom"><div className="upgrade-card"><Sparkles size={16} /><strong>Unlock more with Pro</strong><span>Get advanced reports and automation.</span><button onClick={() => notify('Thanks for your interest in Pro!')}>Explore Pro <ArrowUpRight size={13} /></button></div><div className="profile"><div className="profile-avatar">JD</div><div><strong>Jordan Davis</strong><span>Admin</span></div><MoreHorizontal size={17} className="profile-more" /></div></div>
      </aside>
